/*******************************************************************
*
*  DESCRIPTION: Atomic Model : LTSNetwork
...
#ifndef __LTSNETWORK_H
#define __LTSNETWORK_H
#define LVERBOSE false
/** include files **/
...
//#include <set>
/** declarations **/
class NetworkGraph: public Atomic
{
public:


	NetworkGraph( const string &name = "NetworkGraph" ) ;	 // Default constructor

	~NetworkGraph();					// Destructor
