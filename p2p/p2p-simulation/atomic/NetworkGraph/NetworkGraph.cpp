/*******************************************************************
*
*  DESCRIPTION: Atomic Model : The NetworkGraph model keeps track of the overlay network
*  topology. It is a state machine (an LTS), and its inputs are messages from the peers
*  that go online, offline, or attempt to connect to other peers. The component only
*  changes the graph state following legal transitions, and outputs messages to notify
*  peers of successfully established connections, and of dropped connections.
*
*  This implementation manages this functionality, and introduces minimal latency:
*  successful connections are almost instantaneous.
*
*  AUTHOR: Alan
*
*
...
#include "NetworkGraph.h"  // base header
...
/*******************************************************************
* Function Name: NetworkGraph
* Description: constructor
********************************************************************/
NetworkGraph::NetworkGraph( const string &name )
: Atomic( name )
...
* Description: the NetworkGraph gets input from outside
********************************************************************/
Model &NetworkGraph::externalFunction( const ExternalMessage &msg ){
...
********************************************************************/
Model &NetworkGraph::internalFunction( const InternalMessage & ){
...
********************************************************************/
Model &NetworkGraph::outputFunction( const InternalMessage &msg )
{
